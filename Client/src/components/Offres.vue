...
<template>
  <div class="shop-wrapper" :class="{ fade: animate }">
    ...
    <div class="div2">
      <div class="products-container">
        <div class="product-box">
          <div class="titre">
            <Titre :text="'Offres'" size="64px"></Titre>
    ...
    <div class="div3">
      <div class="product-box">
        <div class="titre">
          <Titre text="Panier" size="64px"></Titre>
        </div>
      </div>
      <Cart :cart-product-list="cartStore.cartProductList" @delete-cart-product="cartStore.removeCartProduct" />
    </div>
  </div>
</template>
